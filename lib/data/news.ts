...
export const AI_NEWS_ITEMS: AINewsItem[] = [
  {
    id: 'news-1',
    slug: 'moonshot-kimi-k3-open-weights-release',
    title: 'Kimi K3 Open Weights Drop Today: World\'s Largest Open-Source Model at 2.8 Trillion Parameters',
    excerpt: 'Moonshot AI releases full open-source weights for Kimi K3, a 2.8T parameter MoE model with Kimi Delta Attention (KDA), making it the first open model in the 3-trillion-parameter class.',
    ...
    featured: true,
    content: {
      whatChanged: 'Moonshot AI publicly released the full open-source weights for Kimi K3 on July 27, 2026. The 2.8 trillion-parameter Mixture-of-Experts model features Kimi Delta Attention (KDA), activating 160B parameters per token. Initially available via API on July 16, the open-weight release makes it the largest downloadable AI model in history.',
      whyItMatters: 'Kimi K3 delivers frontier-grade performance in coding, knowledge work, and long-horizon agentic workflows while being fully downloadable. KDA enables efficient sparse attention routing, dramatically reducing inference costs on commodity GPU clusters compared to dense architectures of similar capability.',
      futureImpact: 'Sets a new precedent for open-weight scale, intensifying pressure on Western frontier labs to justify proprietary licensing. Enterprise teams can now deploy a 3-trillion-class model on-premises, reshaping the economics of private AI infrastructure.',
      technicalHighlights: [
        '2.8 Trillion total parameters (160B active per token via MoE)',
        'Kimi Delta Attention (KDA) for efficient sparse attention routing',
        'State-of-the-art performance on coding, math, and long-horizon agentic benchmarks',
